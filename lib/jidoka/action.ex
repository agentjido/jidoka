defmodule Jidoka.Action do
  ...
  defdelegate normalize_registry(actions), to: Jidoka.Tool, as: :normalize_available_tools
  ...
  defdelegate resolve_names(names, registry), to: Jidoka.Tool, as: :resolve_tool_names
end
