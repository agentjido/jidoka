defmodule JidokaExample.LuaToolsAgent.Actions.LuaToolsExecute do
  ...
  use Jidoka.Action,
    ...
    description:
      "Executes a short sandboxed Lua script that returns a jidoka.workflow plan over selected read-only host capabilities.",
    schema:
      Zoi.object(%{
        script: Zoi.string(),
  ...
  def run(params, context) do
    ...
    max_parallel_calls = params |> get(:max_parallel_calls, 8) |> to_integer()
    timeout = params |> get(:timeout, 1_500) |> to_integer()
